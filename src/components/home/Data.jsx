...
function Data() {
    return (
        <div className="home_data">
            <h1 className='home_title'>Sahil Kumar
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home_subtitle">Java Full Stack Developer</h3>
            <p className='home_description'>Turning ideas into seamless digital experiences.
                Java Full Stack development done right.
            </p>
